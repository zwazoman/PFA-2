...
//    private Queue<GameObject> _activeDecor = new(); // A SAVE Il active tout les nodes contenue en lui
...
//        {
//            if(MapBuildingTools.Instance.ReturnNodeFromNodePosition(node.Position, 3).Intersection && MapBuildingTools.Instance.ReturnNodeFromNodePosition(node.Position, 3).Hauteur != 3)
//            {
//                /*Intersection*/
