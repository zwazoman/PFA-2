...
public static class SaveManager
{
    ...
    public static void Save<T>(string saveKey, T data, bool encrypt = false)
    {
        ...
        //Debug.Log($"Donn�es sauvegard�es, cl� : '{saveKey}'");
    }
    ...
    public static T Load<T>(string saveKey, bool encrypt = false) where T : new()
    {
        ...
        if (!File.Exists(path))
        {
            Debug.LogWarning($"Aucun fichier de sauvegarde trouv� � '{path}'");
            return new T();
        }
        ...
        //Debug.Log($"Donn�es charg�es depuis '{saveKey}'");
        return data;
    }
    ...
    public static void Delete(string saveKey)
    {
        ...
        {
            File.Delete(path);
            //Debug.Log($"Fichier '{saveKey}' supprim�");
        }
    }
